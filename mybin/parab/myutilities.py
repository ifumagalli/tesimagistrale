...
class RestrictFunction(object):
	...
	def __init__(self,big_mesh,restr_line = None):#geometry.moving_boundary):
		...
		mfunc = MeshFunction("size_t",self._big_boundary,1)
...
if __name__=="__main__":
	...
	N = 25
	Omega = UnitSquareMesh(N,N,"crossed")
	...
	Q = FunctionSpace(UnitIntervalMesh(N),'CG',1)
	pq = project(q,Q)
...
#	print q.vector().str(True)
	...
	plot(u_restr,mesh=UnitIntervalMesh(10))
	interactive()
