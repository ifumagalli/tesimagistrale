...
print " -- Control some errors with Fenics -- "
print " L2 = %g , Linf = %g , H1 = %g" % errornorm(uex,u,'l2'), errornorm(uex,u,'linf'), errornorm(uex,u,'h1')
print "---- Errors computing- end ----"
